...
python make_nsfw_model.py --image_dir $PWD/../images --image_size 224 --saved_model_dir $PWD/../trained_models/mobilenet_v2_050_224 --labels_output_file $PWD/../trained_models/mobilenet_v2_050_224/class_labels.txt --tfhub_module https://tfhub.dev/google/imagenet/mobilenet_v2_050_224/feature_vector/4 --tflite_output_file $PWD/../trained_models/mobilenet_v2_050_224/saved_model.tflite --train_epochs 9001 --batch_size 72 --do_fine_tuning --dropout_rate 0.0 --label_smoothing=0.0 --validation_split=0.1 --do_data_augmentation=True --use_mixed_precision=True --rmsprop_momentum=0.0
...
python make_nsfw_model.py --image_dir $PWD/../images --image_size 224 --saved_model_dir $PWD/../trained_models/mobilenet_v2_100_224 --labels_output_file $PWD/../trained_models/mobilenet_v2_100_224/class_labels.txt --tfhub_module https://tfhub.dev/google/imagenet/mobilenet_v2_100_224/feature_vector/4 --tflite_output_file $PWD/../trained_models/mobilenet_v2_100_224/saved_model.tflite --train_epochs 9001 --batch_size 48 --do_fine_tuning --dropout_rate 0.0 --label_smoothing=0.0 --validation_split=0.1 --do_data_augmentation=True --use_mixed_precision=True --rmsprop_momentum=0.0

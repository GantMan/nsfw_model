...
tensorflowjs_converter --input_format=tf_saved_model --output_format=tfjs_graph_model --signature_name=serving_default --saved_model_tags=serve %cd%\..\trained_models\mobilenet_v2_035_224 %cd%\..\trained_models\mobilenet_v2_035_224\web_model
:: Or, for a quantized (1 byte) version
tensorflowjs_converter --input_format=tf_saved_model --output_format=tfjs_graph_model --signature_name=serving_default --saved_model_tags=serve %cd%\..\trained_models\mobilenet_v2_035_224 %cd%\..\trained_models\mobilenet_v2_035_224\web_model_quantized --quantization_bytes 1

tensorflowjs_converter --input_format=tf_saved_model --output_format=tfjs_graph_model --signature_name=serving_default --saved_model_tags=serve %cd%\..\trained_models\mobilenet_v2_050_224 %cd%\..\trained_models\mobilenet_v2_050_224\web_model
:: Or, for a quantized (1 byte) version
tensorflowjs_converter --input_format=tf_saved_model --output_format=tfjs_graph_model --signature_name=serving_default --saved_model_tags=serve %cd%\..\trained_models\mobilenet_v2_050_224 %cd%\..\trained_models\mobilenet_v2_050_224\web_model_quantized --quantization_bytes 1

tensorflowjs_converter --input_format=tf_saved_model --output_format=tfjs_graph_model --signature_name=serving_default --saved_model_tags=serve %cd%\..\trained_models\mobilenet_v2_075_224 %cd%\..\trained_models\mobilenet_v2_075_224\web_model
:: Or, for a quantized (1 byte) version
tensorflowjs_converter --input_format=tf_saved_model --output_format=tfjs_graph_model --signature_name=serving_default --saved_model_tags=serve %cd%\..\trained_models\mobilenet_v2_075_224 %cd%\..\trained_models\mobilenet_v2_075_224\web_model_quantized --quantization_bytes 1

tensorflowjs_converter --input_format=tf_saved_model --output_format=tfjs_graph_model --signature_name=serving_default --saved_model_tags=serve %cd%\..\trained_models\mobilenet_v2_100_224 %cd%\..\trained_models\mobilenet_v2_100_224\web_model
:: Or, for a quantized (1 byte) version
tensorflowjs_converter --input_format=tf_saved_model --output_format=tfjs_graph_model --signature_name=serving_default --saved_model_tags=serve %cd%\..\trained_models\mobilenet_v2_100_224 %cd%\..\trained_models\mobilenet_v2_100_224\web_model_quantized --quantization_bytes 1
